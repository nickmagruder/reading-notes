...
# EJS Partials
# Hensle Joseph Aug 6, 2016
## This section is a reading notes summary based on the article referenced here
[https://medium.com/@henslejoseph/ejs-partials-f6f102cb7433](https://medium.com/@henslejoseph/ejs-partials-f6f102cb7433)

* Partials are for reusing HTML in multiple views, making larger sites easier
* <%-%> tags allow the outputting of *unescaped* content 

# Intro to EJS - Partials - 7 - YouTube Video
# By John from WalkThroughCode
## This section is a notes summary based on the video referenced here
[https://www.youtube.com/watch?v=3_xEEH4fTEk&t=0s&index=7&list=PL7sCSgsRZ-slYARh3YJIqPGZqtGVqZRGt](https://www.youtube.com/watch?v=3_xEEH4fTEk&t=0s&index=7&list=PL7sCSgsRZ-slYARh3YJIqPGZqtGVqZRGt)

* Partials are native to EJS
* For a navbar or footer, reusable & static
